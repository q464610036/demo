...
public class SpringControllerCollectsTest {
	...
	public void isTarget() throws NotFoundException {
		...
		String classname = "com.controller.collects.SpringControllerCollectsTest$SpringControllerMock";
		ClassLoader loader = SpringControllerCollectsTest.class
				.getClassLoader();
		ClassPool pool = new ClassPool();
		pool.insertClassPath(new LoaderClassPath(loader));
		CtClass cclass = pool.get(classname);
		boolean flag = ins.isTarget(classname, loader, cclass);
		Assert.isTrue(flag);
	}
	...
	public void transformTest() throws Exception {
		...
		SpringControllerCollects ins = SpringControllerCollects.INSTANCE;
		String classname = "com.controller.collects.SpringControllerCollectsTest$SpringControllerMock";
		ClassLoader loader = com.controller.collects.SpringControllerCollectsTest.class
				.getClassLoader();
		ClassPool pool = new ClassPool();
		pool.insertClassPath(new LoaderClassPath(loader));
		CtClass cclass = pool.get(classname);
