...
import com.controller.collects.ErrorLog;
import com.controller.common.NetUtils;
import com.controller.json.JsonWriter;
...
public abstract class AbstractCollects {
    ...
    static {
         ...
         *  最大队例:1000
         */
        threadService = new ThreadPoolExecutor(20, 100,
    ...
    public void end(Statistics stat) {
        ...
        sendStatistics(stat);
          System.out.println("time:" + stat.toString());
    }
