package com.spring.annotationDriver;

import com.spring.annotationDriver.aop.MathCalculator;
import com.spring.annotationDriver.bean.*;
import com.spring.annotationDriver.config.*;
import com.spring.annotationDriver.ext.ExtConfig;
import com.spring.annotationDriver.service.BookService;
import com.spring.annotationDriver.tx.TxConfig;
import com.spring.annotationDriver.tx.UserService;
...
//		test11();
    ...
    public static void test12() {
        ...
        com.spring.annotationDriver.ext.UserService userService = applicationContext.getBean(com.spring.annotationDriver.ext.UserService.class);
        applicationContext.close();
    }
}
