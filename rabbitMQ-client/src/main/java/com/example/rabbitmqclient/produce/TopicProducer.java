...
public class TopicProducer {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //routingKey为路由键的值
        channel.basicPublish("simple_exchange", "lazy.black.elephant", true, false, MessageProperties.BASIC, message.getBytes());
        channel.basicPublish("simple_exchange", "lazy.white.sheep", true, false, MessageProperties.BASIC, message.getBytes());
        // 关闭资源
        channel.close();
        connection.close();
    }
