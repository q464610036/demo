...
public class RoutingProducer {
    ...
    public static void main(String[] args) throws Exception {
        ...
        channel.exchangeDeclare("simple_exchange", BuiltinExchangeType.DIRECT,
                false, true, false, null);
        channel.queueBind("queue1", "simple_exchange","key1");
        channel.queueBind("queue2", "simple_exchange", "key2");
