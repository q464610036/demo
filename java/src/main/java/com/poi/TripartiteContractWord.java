 ...
 * @date 2022/7/8
 */
public class TripartiteContractWord {
    private static String wordTempFile = "D://test/tripartite contract/三方合同_code.docx";
    private static String excelFolder = "D://test/tripartite contract/excel/";
    private static String outFolder = "D://test/tripartite contract/三方合同/";
    ...
    public static void main(String[] args) throws Exception {
        ...
        List<Student> list = TripartiteContractWord.readExcel();
