...
COMMENT ON COLUMN CT_TMOS_EQUIPMENT_PLAN_ORDER.CREATE_BY IS '创建人';
COMMENT ON COLUMN CT_TMOS_EQUIPMENT_PLAN_ORDER.CREATE_TIME IS '创建时间';
COMMENT ON COLUMN CT_TMOS_EQUIPMENT_PLAN_ORDER.UPDATE_BY IS '更新人';
COMMENT ON COLUMN CT_TMOS_EQUIPMENT_PLAN_ORDER.UPDATE_TIME IS '更新时间';


-- modify 2024-8-12
ALTER TABLE CT_TMOS_EQUIPMENT_PLAN ADD MERGE_TO_PLAN_ID VARCHAR2(64) NULL;
COMMENT ON COLUMN CT_TMOS_EQUIPMENT_PLAN.MERGE_TO_PLAN_ID IS '合并到的计划id主键';

ALTER TABLE CT_TMOS_EQUIPMENT_PLAN_ITEM ADD MERGE_TO_PLAN_ID VARCHAR2(64) NULL;
...
ALTER TABLE CT_TMOS_EQUIPMENT_BORROW_UNIT MODIFY UNIT_USER_CODE VARCHAR2(32) NULL;

-- modify 2024-8-15
ALTER TABLE CT_TMOS_EQUIPMENT_ORDER MODIFY STOP_LINE_TYPE VARCHAR2(5) NULL;

-- modify 2024-8-23
ALTER TABLE CT_TMOS_EQUIPMENT_INCOMPLETE ADD BORROW_NO VARCHAR2(64) NULL;
COMMENT ON COLUMN CT_TMOS_EQUIPMENT_INCOMPLETE.BORROW_NO IS '借机单号';