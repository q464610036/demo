...
-- modify 2024-9-11
ALTER TABLE CT_TMOS_EQUIPMENT_PMS_STUFF ADD STUFF_NAME VARCHAR2(100) NULL;
COMMENT ON COLUMN CT_TMOS_EQUIPMENT_PMS_STUFF.STUFF_NAME IS '物料名称';
COMMENT ON COLUMN CT_TMOS_EQUIPMENT_SPARES_MONIT.SPARES_STATUS IS '备件状态 1-在机 3-下机';

-- modify 2024-9-18
CREATE TABLE CT_TMOS_EQUIPMENT_STOCK_LOG(
                                             ID VARCHAR2(64) NOT NULL,
                                             OPERATION_NODE VARCHAR2(50),
                                             STUFF_NO VARCHAR2(64) NOT NULL,
                                             STOCK_NUM NUMBER(8),
                                             COMMON_STOCK_NUM NUMBER(8),
                                             UP_STOCK_NUM NUMBER(8),
                                             DOWN_STOCK_NUM NUMBER(8),
                                             MONIT_UP_STOCK_NUM NUMBER(8),
                                             MONIT_DOWN_STOCK_NUM NUMBER(8),
                                             MONIT_UP_STOCK_IDS VARCHAR2(2000),
                                             MONIT_DOWN_STOCK_IDS VARCHAR2(2000),
...
COMMENT ON TABLE CT_TMOS_EQUIPMENT_STOCK_LOG IS '部门库存操作日志表';
COMMENT ON COLUMN CT_TMOS_EQUIPMENT_STOCK_LOG.ID IS '唯一标识';
COMMENT ON COLUMN CT_TMOS_EQUIPMENT_STOCK_LOG.OPERATION_NODE IS '操作节点';
COMMENT ON COLUMN CT_TMOS_EQUIPMENT_STOCK_LOG.STUFF_NO IS '料号';
COMMENT ON COLUMN CT_TMOS_EQUIPMENT_STOCK_LOG.STOCK_NUM IS '部门总库存';
COMMENT ON COLUMN CT_TMOS_EQUIPMENT_STOCK_LOG.COMMON_STOCK_NUM IS '良品库存';
COMMENT ON COLUMN CT_TMOS_EQUIPMENT_STOCK_LOG.UP_STOCK_NUM IS '在机库存';
COMMENT ON COLUMN CT_TMOS_EQUIPMENT_STOCK_LOG.DOWN_STOCK_NUM IS '下机库存';
COMMENT ON COLUMN CT_TMOS_EQUIPMENT_STOCK_LOG.MONIT_UP_STOCK_NUM IS '监控上机库存';
COMMENT ON COLUMN CT_TMOS_EQUIPMENT_STOCK_LOG.MONIT_DOWN_STOCK_NUM IS '监控下机库存';
COMMENT ON COLUMN CT_TMOS_EQUIPMENT_STOCK_LOG.MONIT_UP_STOCK_IDS IS '设备监控上机id，多个用逗号隔开';
COMMENT ON COLUMN CT_TMOS_EQUIPMENT_STOCK_LOG.MONIT_DOWN_STOCK_IDS IS '设备监控下机id，多个用逗号隔开';
COMMENT ON COLUMN CT_TMOS_EQUIPMENT_STOCK_LOG.ERROR_CODE IS '异常代码 0-正常 1-实际上下机器数与库存不符 2-负数库存 3-库存总数不一致';
COMMENT ON COLUMN CT_TMOS_EQUIPMENT_STOCK_LOG.STATUS IS '状态 0-正常 1-删除';
COMMENT ON COLUMN CT_TMOS_EQUIPMENT_STOCK_LOG.CREATE_BY IS '创建人';
COMMENT ON COLUMN CT_TMOS_EQUIPMENT_STOCK_LOG.CREATE_TIME IS '创建时间';
COMMENT ON COLUMN CT_TMOS_EQUIPMENT_STOCK_LOG.UPDATE_BY IS '更新人';
COMMENT ON COLUMN CT_TMOS_EQUIPMENT_STOCK_LOG.UPDATE_TIME IS '更新时间';
COMMENT ON COLUMN CT_TMOS_EQUIPMENT_STOCK_LOG.REMARK IS '备注信息';

-- modify 2024-9-19
ALTER TABLE CT_TMOS_EQUIPMENT_TEMPLATE ADD REV VARCHAR2(50) NULL;
COMMENT ON COLUMN CT_TMOS_EQUIPMENT_TEMPLATE.REV IS '版本号';
ALTER TABLE CT_TMOS_EQUIPMENT_GROUP ADD FACTORY_NAME VARCHAR2(32) NULL;
COMMENT ON COLUMN CT_TMOS_EQUIPMENT_GROUP.FACTORY_NAME IS '厂别';