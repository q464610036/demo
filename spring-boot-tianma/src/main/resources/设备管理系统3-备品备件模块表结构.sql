...
-- modify 2024-8-27
ALTER TABLE CT_TMOS_EQUIPMENT_ORDER_P DROP COLUMN stuff_no;
ALTER TABLE CT_TMOS_EQUIPMENT_ORDER_P DROP COLUMN single_goods_id;
...
-- modify 2024-8-28
ALTER TABLE CT_TMOS_EQUIPMENT_PLAN_SPARES DROP COLUMN EXPECT_REPLACE_TIME;
ALTER TABLE CT_TMOS_EQUIPMENT_PLAN_SPARES DROP COLUMN LIFE;
ALTER TABLE CT_TMOS_EQUIPMENT_PLAN_SPARES DROP COLUMN STUFF_NO;
ALTER TABLE CT_TMOS_EQUIPMENT_PLAN_SPARES DROP COLUMN SINGLE_GOODS_ID;
ALTER TABLE CT_TMOS_EQUIPMENT_PLAN_SPARES ADD MERGE_TO_PLAN_ID VARCHAR2(64) NULL;
COMMENT ON COLUMN CT_TMOS_EQUIPMENT_PLAN_SPARES.MERGE_TO_PLAN_ID IS '合并到的计划id主键';
ALTER TABLE CT_TMOS_EQUIPMENT_SPARES_MONIT ADD WARNING NUMBER(5,0) NULL;
COMMENT ON COLUMN CT_TMOS_EQUIPMENT_SPARES_MONIT.WARNING IS '预警设定/天';
ALTER TABLE CT_TMOS_EQUIPMENT_SPARES_MONIT ADD END_TIME DATE NULL;
...
-- modify 2024-9-10
ALTER TABLE CT_TMOS_EQUIPMENT_INCOMPLETE_P ADD UPKEEP_RESULT_LOG VARCHAR2(500) NULL;
COMMENT ON COLUMN CT_TMOS_EQUIPMENT_INCOMPLETE_P.UPKEEP_RESULT_LOG IS '残件状态日志：2=未保养，3=残件，4=寿命上限，5=参数异常，9=保养失败，多个用逗号隔开';