...
CREATE TABLE ct_tmos_equipment_group_temp(
                                             id VARCHAR2(64) NOT NULL,
...
COMMENT ON TABLE ct_tmos_equipment_group_temp IS '设备关系组模版关系表';
COMMENT ON COLUMN ct_tmos_equipment_group_temp.id IS '主键id';
COMMENT ON COLUMN ct_tmos_equipment_group_temp.group_id IS '关系组id';
COMMENT ON COLUMN ct_tmos_equipment_group_temp.template_id IS '模版id';
COMMENT ON COLUMN ct_tmos_equipment_group_temp.STATUS IS '状态 0=正常，1=删除';
COMMENT ON COLUMN ct_tmos_equipment_group_temp.REMARK IS '备注';
COMMENT ON COLUMN ct_tmos_equipment_group_temp.CREATED_BY IS '创建人';
COMMENT ON COLUMN ct_tmos_equipment_group_temp.CREATED_TIME IS '创建时间';
COMMENT ON COLUMN ct_tmos_equipment_group_temp.UPDATED_BY IS '更新人';
COMMENT ON COLUMN ct_tmos_equipment_group_temp.UPDATED_TIME IS '更新时间';
